...
object ModClientEvent {
    ...
    @SubscribeEvent
    fun RegisterClientExtensionsEvent.onRegisterClientExtensions() {
        MaterialFluidType.register
            .forEach { it.content.mapKeys { e -> it.getClientExtUnsafe(e.key) }
            .forEach { (t, u) -> registerFluidType(t, u) } }
    }
}